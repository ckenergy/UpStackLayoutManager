...
public class MyBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    private static final String TAG = MyBottomSheetBehavior.class.getSimpleName();
    ...
    public boolean onLayoutChild(CoordinatorLayout parent, V child, int layoutDirection) {
        Log.d(TAG, "onLayoutChild top:"+child.getTop());
    ...
    public void onStopNestedScroll(CoordinatorLayout coordinatorLayout, V child, View target) {
        ...
        if (mLastNestedScrollDy > 0) {
            top = mMinOffset;
//            top = coordinatorLayout.getHeight() - child.getHeight();
        ...
        Log.d(TAG, "onStopNestedScroll:"+top);
    ...
    void startSettlingAnimation(View child, int state) {
        ...
        Log.d(TAG, "startSettlingAnimation:"+top);
        if (mViewDragHelper.smoothSlideViewTo(child, child.getLeft(), top)) {
            setStateInternal(STATE_SETTLING);
